...
└── docs/                                   # 프로젝트 문서
    ...
    └── notebook_summaries/                 # 노트북 요약 문서 (Claude Code용)
        ...
        ├── 02_고급_도메인_특성공학_summary.md  # 전체 요약 (65KB)
        └── 02_특성공학/                    # 카테고리별 분할 (3.6~14KB)
            ├── README.md                   # 사용 가이드
            ├── 00_개요_및_목차.md
            ├── 01_유동성위기_특성.md
            ├── 02_지급불능패턴_특성.md
...
**해결 2단계: 요약도 큰 경우 카테고리별 분할**
- 문제: `02_고급_도메인_특성공학_summary.md` (65KB)도 다른 컨텍스트와 합쳐지면 부담
- 해결: 카테고리별로 8개 파일로 분할 → `docs/notebook_summaries/02_특성공학/`
- 크기: 3.6KB ~ 14KB (평균 8KB)

**분할된 특성공학 요약 구조:**
```
docs/notebook_summaries/02_특성공학/
├── README.md                        # 사용 가이드
├── 00_개요_및_목차.md               # 8.6KB - 전체 개요, 이론적 배경
├── 01_유동성위기_특성.md            # 5.4KB - 10개 특성
├── 02_지급불능패턴_특성.md          # 3.6KB - 8개 특성
├── 03_재무조작탐지_특성.md          # 5.7KB - 15개 특성
├── 04_한국시장특화_특성.md          # 7.7KB - 13개 특성
├── 05_이해관계자행동_특성.md        # 14KB - 성장성+수익성 포함
├── 06_복합리스크_특성.md            # 7.9KB - 7개 복합 지표
└── 07_상호작용비선형_특성.md        # 13KB - 비선형 + 저장 + 평가
```

**사용 방법:**
- 전체 이해: `00_개요_및_목차.md` 읽기
- 특정 카테고리 작업: 해당 파일만 읽기 (예: `03_재무조작탐지_특성.md`)
- 비교 분석: 여러 파일 동시 읽기 (예: `01` + `02` 유동성 vs 지급불능 비교)
...
# 2. 특성공학 요약 분할 (필요시)
# docs/notebook_summaries/02_특성공학/README.md 참조
```
